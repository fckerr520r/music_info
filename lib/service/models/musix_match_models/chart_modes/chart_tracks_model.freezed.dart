...
ChartTracks _$ChartTracksFromJson(Map<String, dynamic> json) {
  return _ChartTracks.fromJson(json);
}

/// @nodoc
class _$ChartTracksTearOff {
  const _$ChartTracksTearOff();

  _ChartTracks call({required Message message}) {
    return _ChartTracks(
      message: message,
    );
  }

  ChartTracks fromJson(Map<String, Object?> json) {
    return ChartTracks.fromJson(json);
  }
}

/// @nodoc
const $ChartTracks = _$ChartTracksTearOff();
...
mixin _$ChartTracks {
  ...
  @JsonKey(ignore: true)
  $ChartTracksCopyWith<ChartTracks> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ChartTracksCopyWith<$Res> {
  factory $ChartTracksCopyWith(
          ChartTracks value, $Res Function(ChartTracks) then) =
      _$ChartTracksCopyWithImpl<$Res>;
...
/// @nodoc
class _$ChartTracksCopyWithImpl<$Res> implements $ChartTracksCopyWith<$Res> {
  _$ChartTracksCopyWithImpl(this._value, this._then);

  final ChartTracks _value;
  // ignore: unused_field
  final $Res Function(ChartTracks) _then;
...
/// @nodoc
abstract class _$ChartTracksCopyWith<$Res>
    implements $ChartTracksCopyWith<$Res> {
  factory _$ChartTracksCopyWith(
          _ChartTracks value, $Res Function(_ChartTracks) then) =
      __$ChartTracksCopyWithImpl<$Res>;
  @override
  $Res call({Message message});
...
/// @nodoc
class __$ChartTracksCopyWithImpl<$Res> extends _$ChartTracksCopyWithImpl<$Res>
    implements _$ChartTracksCopyWith<$Res> {
  __$ChartTracksCopyWithImpl(
      _ChartTracks _value, $Res Function(_ChartTracks) _then)
      : super(_value, (v) => _then(v as _ChartTracks));

  @override
  _ChartTracks get _value => super._value as _ChartTracks;

  @override
  $Res call({
    Object? message = freezed,
  }) {
    return _then(_ChartTracks(
      message: message == freezed
          ? _value.message
          : message // ignore: cast_nullable_to_non_nullable
              as Message,
...
class _$_ChartTracks implements _ChartTracks {
  const _$_ChartTracks({required this.message});

  factory _$_ChartTracks.fromJson(Map<String, dynamic> json) =>
      _$$_ChartTracksFromJson(json);
  ...
  @override
  String toString() {
    return 'ChartTracks(message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$ChartTracksCopyWith<_ChartTracks> get copyWith =>
      __$ChartTracksCopyWithImpl<_ChartTracks>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ChartTracksToJson(this);
  }
}

abstract class _ChartTracks implements ChartTracks {
  const factory _ChartTracks({required Message message}) = _$_ChartTracks;

  factory _ChartTracks.fromJson(Map<String, dynamic> json) =
      _$_ChartTracks.fromJson;
...
class _$TrackTearOff {
  ...
  _Track call(
      ...
      @JsonKey(name: 'commontrack_id') int commontrackId = 0,
      @JsonKey(name: 'album_id') int albumId = 0,
      @JsonKey(name: 'artist_id') int artistId = 0,
...
mixin _$Track {
  ...
  int get commontrackId => throw _privateConstructorUsedError;
...
abstract class $TrackCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'track_name') String? trackName,
      @JsonKey(name: 'commontrack_id') int commontrackId,
    ...
    return _then(_value.copyWith(
      ...
      trackName: trackName == freezed
          ...
          : trackName // ignore: cast_nullable_to_non_nullable
              as String?,
      commontrackId: commontrackId == freezed
          ? _value.commontrackId
          : commontrackId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_Track implements _Track {
  const _$_Track(
      ...
      @JsonKey(name: 'commontrack_id') this.commontrackId = 0,
  ...
  @override
  String toString() {
    return 'Track(trackId: $trackId, trackName: $trackName, commontrackId: $commontrackId, albumId: $albumId, artistId: $artistId, artistName: $artistName)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.commontrackId, commontrackId) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(commontrackId),
